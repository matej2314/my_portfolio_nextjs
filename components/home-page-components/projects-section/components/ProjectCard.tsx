	...
	return (
		<div ref={rootRef} className='relative h-[280px] min-h-[280px] w-full'>
			<a
				href={href}
				onClick={onClick}
				className='group block h-full w-full outline-none ring-0 focus:outline-none focus-visible:outline-none focus-visible:ring-0'
			>
				<div className='relative flex h-[280px] w-full flex-col justify-end overflow-hidden rounded-xl border border-[#facc15] bg-[#0c0c0c] shadow-md'>
					<Image
						...
						fill
						className='object-cover opacity-70 transition duration-300 group-hover:scale-105 group-hover:opacity-100 group-focus:scale-105 group-focus:opacity-100 group-focus-visible:scale-105 group-focus-visible:opacity-85'
