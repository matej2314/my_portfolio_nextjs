...
import { observeAssistantResult, incrementAssistantTopicRejections } from '@/lib/metrics/assistantMetrics';
...
export const handleNotAllowedTopic = ({ topicCheck, SSE_HEADERS }: HandleNotAllowedTopicParams) => {
	observeAssistantResult('topic_rejected');
	incrementAssistantTopicRejections();
