...
export default function ContactSection() {
    ...
    return (
        <section id="contactSection" className="w-full sm:w-full h-full flex flex-col justify-center pb-2 font-kanit">
            ...
            <section className="w-full h-full flex flex-col md:flex-row justify-center items-center mt-3 md:mb-10">
                <div className="w-full text-slate-200 flex flex-col items-center justify-start">
                    ...
                    <h3 className=" text-[0.82rem] sm:text-base sm:ml-4 mb-10">{t("contactSection.subTitle")}</h3>
                    <ContactItems />
                </div>
