...
export default async function SkillsSection() {
    ...
    return (
        <section id="skillsSection" className="w-full h-screen flex flex-col mb-4.5">
            <span className="text-4xl text-green-400 ml-2">Skills &#123;</span>
            <section className="w-full h-full flex justify-between mt-10">
                <div className="w-1/3 text-slate-200">
