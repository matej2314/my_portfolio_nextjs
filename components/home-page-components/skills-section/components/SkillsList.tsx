    ...
    return (
        <div className="relative max-w-screen w-full sm:w-screen xl:w-full min-h-[15rem] h-[15rem] text-white flex flex-col items-center gap-5 xl:gap-7 mb-[6rem]">
            ...
            <motion.ul
                ...
                className='w-full grid grid-cols-3 mr-2 gap-x-[1rem] min-[400px]:ml-[2rem] min-[455px]:gap-x-[0.5rem] min-[455px]:ml-[3.5rem] min-[555px]:ml-[5rem] sm:ml-[3rem] sm:gap-y-2 xl:gap-x-[3rem] xl:gap-y-[2rem] xl:ml-3 gap-y-6 sm:mx-auto'
            >
                <AnimatePresence>
                    {filteredSkills.map(skill => (
                        <motion.li
                            ...
                            className='w-fit h-[2rem] flex justify-start items-center gap-3 hover:scale-110 xl:text-wrap ml-[0.3rem] md:ml-0'
                        >
                            <span>
                                <Icon
                            ...
                            <span className='text-[0.7rem] md:text-lg xxl:text-xl'>
                                {skill.skill_name}
                            </span>
                        </motion.li>
                    ))}
