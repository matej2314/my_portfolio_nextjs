...
export default function ContactSection() {
    ...
    return (
        <section id="contactSection" className="w-full h-full flex flex-col justify-center pb-2 font-kanit">
            <span className="text-4xl text-green-400 ml-2">Contact &#123;</span>
            <section className="w-full h-full flex flex-col md:flex-row mt-5 md:mb-10">
                ...
                <div className="w-full h-full translate-x-1/4 sm:translate-x-1/3 md:translate-x-1/6 text-slate-200 flex flex-col items-center mt-[2rem] sm:mt-0">
                    <ContactForm />
                </div>
            </section>
